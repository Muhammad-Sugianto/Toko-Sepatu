        ...
        <div class="row">
            ...
            <div class="col-lg-15">
                <div class="card">
                    ...
                    <div class="mb-3"   >
                        <a href="<?= base_url('gambarproduk') ?>" class="btn btn-danger rounded-pill"><i class="bi bi-x-circle"> Close</a></i>
              ...
              <div class="row">
                   <?php foreach ($gambar as $key => $value) { ?>
                    <div class="col-sm-3">
                    <div class="mb-3">
                      <img src="<?= base_url('assets/gambarproduk/' .$value->gambar) ?>" id="gambar_load" width="210px" height="200px">
                    </div>
                    <a for="">Ket : <?= $value->keterangan ?></a>
                    <a href="#" class="btn btn-danger rounded-pill btn-block"><i class="bi bi-trash3"> Delete</a></i>
                    </div>
              <?php     }?> 
